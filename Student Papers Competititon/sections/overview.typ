...
Автори заявляють про досягнення показника F1=99% для детекції номерних знаків, але не вказали поріг IoU, що дозволяє припустити зарахування будь-якого повного входження знака в рамку як позитивного результату. Точність розпізнавання символів (_character-level accuracy_) становить 99.95%.
